            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    aut_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    aut_nombre = table.Column<string>(type: "text", nullable: false),
                    aut_descripcion = table.Column<string>(type: "text", nullable: false),
                    aut_precio = table.Column<decimal>(type: "numeric", nullable: false),
                    aut_especificacion = table.Column<string>(type: "text", nullable: false),
