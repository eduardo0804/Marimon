        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    usu_num_identificacion = table.Column<string>(type: "text", nullable: true),
                    usu_correo = table.Column<string>(type: "text", nullable: true),
                    usu_contrasena = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    com_factura = table.Column<string>(type: "text", nullable: true),
                    FacturaId = table.Column<int>(type: "integer", nullable: true),
                    com_boleta = table.Column<string>(type: "text", nullable: true),
